...
[tfc0, lambda1,omega1,tfrtic, tcrtic] = CT_2nd(y, Hz, sigma,chrrange);

del_f=tfrtic(2)-tfrtic(1);del_c=tcrtic(2)-tcrtic(1);
[tfrsq1] = Msqueeze_CT(y, tfc0, lambda1, omega1, tfrtic,tcrtic, 1);
tfrsq2 = permute(tfrsq1, [1, 3, 2]);

 [GDs,GDDs]=ridge_3d(tfrsq2,2,30,30,20);
...
%0.001050  0.000991  0.000000  0.000001
