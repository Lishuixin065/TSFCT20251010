...
% y = awgn(y, snr_db, 'measured');
   ...
   %% SST_2nd
 tic
  [Tx1,tfr,f,IF] = SST_2nd_gpu(y, Hz,s);
...
toc
 ...
 %% TSST_2nd 
 tic
   [Tx2,tfc0,t,f,GroupDelay] = TSST_2nd_gpu(y,Hz,s);
...
%% TET_2nd 
tic
   [Tx3,tfc0,t,f,GroupDelay] = TET_2nd_gpu(y,Hz,s);
...
%% TSFCT 
arange=0.0016;
[tfrsq1, tfc0, tfrtic, tcrtic] = SFCT2_with_squeeze_gpu(y, Hz, 2*s, arange, 1, 0.01);
